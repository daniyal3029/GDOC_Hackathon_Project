...
export interface ITaskService {
  getTasks(userId: string, filters: any, pagination: any): Promise<PaginatedResponseDto<TaskResponseDto>>;
  getPendingTasksGrouped(userId: string): Promise<Record<string, TaskResponseDto[]>>;
